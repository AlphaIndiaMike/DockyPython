...
function write_article($File,$text){
 ...
 function base_Article($File,&$header,$edit,$width,$height){
        ...
        if (has_access()==true)
        {
            $r .= '<div style="display:block; width:'.$width.' height:24px; text-align:right; padding-right:20px; position:relative; z-index:99;">
 ...
 function base_Article_link($File,&$header,$width=1000,$height=200){
    $razor='';
